...
st.markdown("Predict final project costs using **Ridge Regression** trained on augmented synthetic data.")
...
if st.button("Calculate Final Cost", type="primary"):
    ...
    input_data['Total_Prelim_Est'] = floor_area * prelim_est_unit

    manual_vars = ['Total_Floor_Area', 'Lot_Area', 'Duration', 'Prelim_Est_Unit_Cost', 
                   'Unit_Price_Start', 'Project_Locality', 'Total_Prelim_Est']
    ...
    st.success(f"### Predicted Cost: {prediction:,.2f} Units")
